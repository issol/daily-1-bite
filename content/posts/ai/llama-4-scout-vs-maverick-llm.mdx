...
date: "2026-02-18"
description: "&lt;p&gt;회사에서 사내 문서 검색 시스템을 만들고 있었습니다. Claude API를 쓰고 있었는데, 월 비용이 슬슬 부담되기 시작하더군요. &amp;quot;오픈소스 모델로 바꾸면 비용을 반 이하로 줄일 수..."
category: "ai"
tags: []
---
...
회사에서 사내 문서 검색 시스템을 만들고 있었습니다. Claude API를 쓰고 있었는데, 월 비용이 슬슬 부담되기 시작하더군요. &quot;오픈소스 모델로 바꾸면 비용을 반 이하로 줄일 수 있지 않을까?&quot; 하는 생각이 들었을 때, 마침 Meta가 Llama 4를 공개했습니다.
 ...
 _AI 칩 위에 새겨진 글자를 보여주는 인공지능 기술 이미지_
...
## Scout과 Maverick, 뭐가 다른 건가
 ...
 _머신러닝 신경망 구조를 시각화한 3D 렌더링 이미지_
