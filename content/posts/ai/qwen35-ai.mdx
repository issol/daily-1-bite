...
## 설치/설정 과정
 ...
 # Ollama가 없다면 먼저 설치 curl -fsSL https://ollama.com/install.sh | sh # Qwen3.5 모델 다운로드 (8B 버전 기준, 약 4.9GB) ollama pull qwen3.5:8b # 바로 실행 ollama run qwen3.5:8b _맥북 화면에 코드가 표시된 개발 환경_
