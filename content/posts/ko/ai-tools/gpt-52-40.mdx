...
- [Qwen3.5 리뷰: 알리바바 오픈소스 AI를 로컬에서 직접 돌려봤다](https://daily1bite.com/blog/ai-tools/qwen35-ai) (오픈소스 LLM과의 비교 관점)
- [Llama 4 Scout vs Maverick 완전 분석](https://daily1bite.com/blog/ai-tools/llama-4-scout-vs-maverick-llm) (LLM 모델 비교 시리즈)