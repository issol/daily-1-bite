...
## 그래서, 누구에게 추천하나?
 ...
 혹시 Windsurf를 이미 써보신 분 있으신가요? 제 체감과 다른 부분이 있다면 댓글로 알려주세요. 다른 분들의 경험도 궁금합니다.
  ...
  [ChatGPT vs Claude 실사용 비교: 어느 쪽이 더 쓸만한가](https://daily1bite.com/blog/dev-life/anthropic-claude-ai-vs) (AI 도구 비교가 궁금하다면) [내가 AI 도구를 3개월 써본 솔직 후기](https://daily1bite.com/blog/ai-tools/ai-3-2) (AI 코딩 도구 전반에 대한 경험담) 